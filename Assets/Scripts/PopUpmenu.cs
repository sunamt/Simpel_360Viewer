...
{ 
	...
	public class PopUpmenu : MonoBehaviour
    {
        ...
        private void Update()
        {
			...
			m_TargetAlpha =  Mathf.Abs(m_DesiredDirection.forward.y) > 0.75f ? 1f : 0f;
           ...
           float angleDeltaHoriz = Vector3.Angle (desiredForward, flatCamHoriz); //move


			//move the menu with slerp acording to fixed camera flat plane
